...
const Basket = ({ cart, clearCart }) => {
  ...
  return (
    <div className="ıcecreamBasketContainer">
...
const ıceCream = () => {
  const [ıcecream, setIcecream] = useState([]);
  const [cart, setCart] = useState([]);

  useEffect(() => {
    // data isteği 
    setIcecream(ıceCreamData);
  ...
  return (
    <>
      <div className="watercontainer">
        <div className='data'>
          {ıcecream.length && ıcecream.map(product => (
